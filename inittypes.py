...
class InitTypes(SnapshotPlugin):

    def __init__(self):
        super(InitTypes, self).__init__()
        # add a name and description that we can put on the website
        self._modulename = "Initialization Types"
        self._description = "Show initialization attempts - absolute vs relative changes"
